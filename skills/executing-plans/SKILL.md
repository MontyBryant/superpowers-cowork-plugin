...
description: Use for non-code knowledge work when you have an approved plan to execute -- either from
  the writing-plans skill or a plan document your human partner provides. Triggers on "execute the plan",
  "follow the plan", "work through these tasks", "start executing", "run through the steps", or when a
  plan exists and the user signals readiness to begin. Also triggers when resuming execution of a partially
  completed plan.
---
